...
import { Globe, Bot, Zap, ShoppingBag, TrendingUp, Smartphone, Code2, Palette, Calendar, MapPin, Star, CheckCircle, ArrowRight, Users, Target, Award, Bitcoin } from 'lucide-react';
...
const Services = () => {
  ...
  const services = [{
    ...
    features: ["Custom responsive design", "SEO optimization", "Performance optimization", "Mobile-first approach", "CMS integration", "E-commerce functionality"],
    ...
    features: ["Custom AI chatbots", "Workflow automation", "Data analysis & insights", "Process optimization", "Integration with existing systems", "24/7 automated support"],
    ...
    features: ["Scalable cloud architecture", "User management systems", "Payment integration", "Multi-tenant architecture", "API development", "Analytics & reporting"],
    ...
    features: ["Custom store design", "Payment gateway integration", "Inventory management", "Order tracking system", "Marketing automation", "Mobile commerce optimization"],
    ...
    features: ["SEO optimization", "Content marketing", "Social media management", "PPC advertising", "Email marketing", "Analytics & reporting"],
    ...
    features: ["Cross-platform development", "Native iOS & Android apps", "UI/UX design", "App store optimization", "Push notifications", "Offline functionality"],
    ...
    features: ["Custom business logic", "Database design", "API integrations", "User role management", "Reporting & analytics", "Scalable architecture"],
    ...
    features: ["User research & testing", "Wireframing & prototyping", "Visual design", "Interaction design", "Design system creation", "Accessibility compliance"],
  ...
  return <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/20 to-teal-50/30">
      <GoogleAnalytics />
        ...
        <section className="mobile-spacing px-3 sm:px-4 lg:px-6">
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
              ...
              return <Card key={service.id} className="group relative bg-white/90 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 md:hover:-translate-y-2 rounded-xl md:rounded-3xl overflow-hidden animate-slide-up" style={{
                animationDelay: `${index * 0.1}s`
              }}>
                    {service.popular && <div className="absolute top-3 md:top-4 right-3 md:right-4 z-10">
                    ...
                    <CardContent className="p-3 md:p-6">
                      ...
                      <div className="mb-3 md:mb-4 hidden md:block">
                        <div className="flex flex-wrap gap-2">
                          {service.features.slice(0, 3).map((feature, idx) => <div key={idx} className="flex items-center text-xs text-gray-600">
                      ...
                      <Button onClick={() => handleBookService(service.id)} size="sm" className={`w-full bg-gradient-to-r ${service.gradient} hover:opacity-90 text-white shadow-lg hover:shadow-xl transition-all duration-300 group text-xs md:text-sm py-2 md:py-3`}>
        ...
        <section className="mobile-spacing px-3 sm:px-4 lg:px-6 bg-gradient-to-r from-primary to-accent">
          <div className="container mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center animate-fade-in">
              <Button size="sm" variant="secondary" className="bg-white text-primary hover:bg-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 px-6 py-3 text-sm" onClick={() => navigate('/quote')}>
                Get Free Quote
              </Button>
              <Button size="sm" variant="outline" className="border-white text-white hover:bg-white hover:text-primary shadow-lg hover:shadow-xl transition-all duration-300 px-6 py-3 text-sm" onClick={() => navigate('/portfolio')}>
                View Portfolio
              </Button>
            </div>
          </div>
