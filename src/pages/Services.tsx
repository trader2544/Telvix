            ...
            <div className="max-w-4xl mx-auto space-y-4">
              {services.map((service, index) => {
                ...
                return (
                  ...
                  >
                    <div 
                      className={`bg-card border border-border/50 rounded-2xl overflow-hidden transition-all duration-500 ${
                        isExpanded ? 'shadow-xl shadow-primary/10' : 'shadow-sm hover:shadow-md'
                      }`}
                    >
                              ...
                              <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-4">
                                  ...
                                  <Button
                                    ...
                                    className={`w-full mt-6 bg-gradient-to-r ${service.gradient} hover:opacity-90 text-white rounded-xl h-12`}
                                  >
