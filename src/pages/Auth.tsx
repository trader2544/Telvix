...
const FloatingOrb = ({ delay, size, x, y }: { delay: number; size: number; x: string; y: string }) => (
  <motion.div
    className="absolute rounded-full bg-gradient-to-br from-primary/30 to-primary/10 blur-xl"
...
const Auth = () => {
  ...
  const features = [
    { icon: Zap, text: "Track project progress in real-time" },
    { icon: Shield, text: "Secure communication with our team" },
    { icon: Sparkles, text: "Suggest changes and improvements" },
  ];
                ...
                <AnimatePresence mode="wait">
                  <TabsContent value="signin" key="signin">
                    ...
                    >
                      <div className="space-y-2">
                        ...
                        <div className="relative group">
                          <Input
                            ...
                            required
                            className="h-12 rounded-xl bg-muted/30 border-border/50 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all pl-4"
                          />
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative group">
                          <Input
                            ...
                            required
                            className="h-12 rounded-xl bg-muted/30 border-border/50 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all pl-4 pr-12"
                          />
                          <Button
                            type="button"
                            variant="ghost"
                      ...
                      <Button 
                        type="submit" 
                        className="w-full h-12 rounded-xl group bg-primary hover:bg-primary/90 text-primary-foreground font-semibold shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300" 
                        disabled={loading}
                      >
                        {loading ? (
                          <>
                  ...
                  <TabsContent value="signup" key="signup">
                    ...
                    >
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            <Input
                              ...
                              onChange={(e) => setPassword(e.target.value)}
                              required
                              className="h-12 rounded-xl bg-muted/30 border-border/50 focus:border-primary transition-colors pr-10"
                            />
                            <Button
                              type="button"
                              variant="ghost"
                      ...
                      {/* Captcha */}
                      <motion.div 
                        className="p-4 rounded-2xl bg-gradient-to-br from-muted/50 to-muted/30 border border-border/50 backdrop-blur-sm"
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <Input
                            ...
                            required
                            className="w-20 h-12 rounded-xl bg-background/50 border-border/50 focus:border-primary text-center font-bold text-lg"
                          />
                        </div>
                      </motion.div>
