...
const sections = [{
  ...
  list: ['Contact us through our website forms', 'Subscribe to our newsletters or updates', 'Request quotes or consultations', 'Apply for career opportunities'],
  footer: 'This may include your name, email address, phone number, company information, and project details.'
}, {
  icon: Database,
  title: 'How We Use Your Information',
  content: ['We use the information we collect to:'],
  list: ['Respond to your inquiries and provide customer support', 'Send you project updates and communications', 'Process job applications and recruitment', 'Improve our services and website functionality', 'Comply with legal obligations']
}, {
  icon: UserCheck,
  title: 'Information Sharing',
  content: ['We do not sell, trade, or otherwise transfer your personal information to third parties except:'],
  list: ['With your explicit consent', 'To trusted service providers who assist us in operating our website', 'When required by law or to protect our rights', 'In connection with a business transfer or merger']
}, {
  icon: Lock,
  title: 'Data Security',
  ...
  list: ['SSL encryption for data transmission', 'Secure servers and databases', 'Regular security audits and updates', 'Limited access to personal information']
}, {
  icon: Mail,
  title: 'Contact Us',
