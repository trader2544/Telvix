      ...
      <main className="pt-16">
        ...
        <section className="py-12 md:py-20 bg-gradient-to-br from-primary via-primary/90 to-accent text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold mb-4 md:mb-6">Privacy Policy</h1>
        ...
        <section className="py-12 md:py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="space-y-8 md:space-y-12">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-lg">
                <div className="flex items-center mb-4 md:mb-6">
                  <Database className="w-6 h-6 md:w-8 md:h-8 text-primary mr-3 md:mr-4" />
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-lg">
                <div className="flex items-center mb-4 md:mb-6">
                  <UserCheck className="w-6 h-6 md:w-8 md:h-8 text-primary mr-3 md:mr-4" />
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-lg">
                <div className="flex items-center mb-4 md:mb-6">
                  <Lock className="w-6 h-6 md:w-8 md:h-8 text-primary mr-3 md:mr-4" />
