...
import { Cookie, Settings, BarChart, Shield, Eye, Mail, AlertTriangle } from 'lucide-react';
const sections = [{
  icon: Eye,
  ...
  list: ['Remembering your preferences and settings', 'Enabling certain website features and functionality', 'Helping us understand how you use our website', 'Providing relevant content and advertisements']
}, {
  icon: Settings,
  ...
  list: ['Google Analytics: To analyze website traffic and user behavior', 'Social Media Platforms: For social sharing and integration features', 'Communication Tools: For chat widgets and customer support'],
  ...
  list: ['Most web browsers allow you to control cookies through their settings', 'You can set your browser to refuse all cookies or alert you when cookies are being sent', 'You can delete cookies that have already been set', 'You can opt out of third-party cookies through their respective websites'],
            ...
            <div className="space-y-8">
              ...
              delay: index * 0.1
                  ...
                  <div className="space-y-4 text-muted-foreground">
                    ...
                    {section.subsections && <div className="space-y-4">
                        {section.subsections.map((sub, i) => <div key={i} className="pl-4 border-l-2 border-primary/30">
                    ...
                    {section.warning && <div className="flex items-start gap-3 p-4 bg-yellow-500/10 rounded-xl border border-yellow-500/20">
