...
import { FileText, Users, CreditCard, AlertTriangle, Scale, Phone, Sparkles } from 'lucide-react';
...
const sections = [
  {
    ...
    content: [
      'By accessing and using Telvix\'s services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.',
  ...
  },
  {
    ...
    list: [
      ...
      'SaaS solutions and platforms',
      'AI integration and automation',
      'Freelance developer placement',
    ],
  ...
  },
  {
    ...
    list: [
      'Kenyan developers and digital professionals',
      'Nigerian developers and digital professionals',
    ],
  ...
  },
  {
    ...
    content: [
      'In no event shall Telvix, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages.',
      'Our liability is limited to the amount paid by you for the specific service in question. We provide services "as is" and make no warranties, express or implied.',
    ],
  },
  {
    icon: Phone,
