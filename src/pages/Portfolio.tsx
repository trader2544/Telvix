              ...
              return (
                <Button
                  ...
                  className={`rounded-full gap-2 transition-all duration-300 ${
                    isActive ? 'shadow-lg shadow-primary/25' : 'hover:bg-muted'
                  }`}
                >
                        ...
                        <div className="group cursor-pointer h-full">
                          <div className="relative bg-card rounded-2xl overflow-hidden border border-border/50 transition-all duration-500 hover:border-primary/30 hover:shadow-2xl hover:shadow-primary/10">
                            ...
                            <div className="relative aspect-[4/3] overflow-hidden">
                              ...
                              {/* Overlay on hover */}
                              <motion.div 
                                className="absolute inset-0 bg-gradient-to-t from-foreground/90 via-foreground/50 to-transparent flex items-end justify-center p-6"
                                initial={{ opacity: 0 }}
