                            ...
                            <div className="flex gap-2 overflow-x-auto pb-2">
                              {resources.slice(0, 5).map((resource) => (
                                <a
                                  ...
                                  className="flex items-center gap-2 px-3 py-2 rounded-lg bg-background hover:bg-muted transition-colors shrink-0"
                                >
                        ...
                        {attachmentFile && (
                          <div className="px-4 py-2 border-t border-border/50 bg-primary/5">
                            <div className="flex items-center gap-3 p-2 rounded-lg bg-background">
                              ...
                              {isImageFile(attachmentFile.type) && (
                                <img
                          ...
                          <div className="flex items-end gap-2">
                            ...
                            <div className="flex-1 relative">
                              <Textarea
                                ...
                                className="min-h-[44px] max-h-32 rounded-2xl bg-muted/50 border-0 focus-visible:ring-1 focus-visible:ring-primary pr-12 resize-none"
                                rows={1}
                              />
                            </div>
                            <Button
                              onClick={sendMessage}
                              disabled={submitting || (!newMessage.trim() && !attachmentFile)}
                              className="shrink-0 rounded-full w-11 h-11 bg-gradient-to-r from-primary to-primary/80 shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all"
                            >
                              {submitting ? (
