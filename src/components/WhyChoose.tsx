...
const WhyChoose = () => {
  ...
  return <section id="why-choose" className="mobile-spacing bg-foreground text-background relative overflow-hidden">
      {/* Background Pattern */}
      ...
      {/* Floating Elements */}
      <motion.div className="absolute top-20 right-20 w-64 h-64 bg-primary/20 rounded-full blur-3xl" animate={{
      y: [0, -20, 0],
      scale: [1, 1.1, 1]
    }} transition={{
      duration: 8,
      ...
      <motion.div className="absolute bottom-20 left-20 w-80 h-80 bg-primary/10 rounded-full blur-3xl" animate={{
      y: [0, 20, 0],
      scale: [1, 0.95, 1]
    }} transition={{
      duration: 10,
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          duration: 0.8
            ...
            <Button onClick={() => navigate('/quote')} className="bg-background text-foreground hover:bg-background/90 rounded-full px-8">
              Get Started
          ...
          <div className="space-y-8">
            {benefits.map((benefit, index) => <motion.div key={benefit.title} className="group" initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
        ...
        {/* Stats */}
        <motion.div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-8" initial={{
        opacity: 0,
        y: 40
      }} whileInView={{
        opacity: 1,
